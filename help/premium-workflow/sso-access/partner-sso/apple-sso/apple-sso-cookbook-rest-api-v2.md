...
> <br/>
>
> * L’application de diffusion en continu a rempli les [ conditions préalables à l’intégration ](/help/premium-workflow/sso-access/partner-sso/apple-sso/apple-sso-overview.md#apple-sso-prerequisites-programmer) qui s’appliquent à un programmeur et sont requises pour activer l’expérience utilisateur d’authentification unique d’Apple.
