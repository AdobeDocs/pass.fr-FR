...
### Limitation De Flux De Base

Limitez le nombre de flux simultanés par abonné dans toutes vos applications.

### Restrictions basées sur l’appareil

Autorisez uniquement un certain nombre de flux par type d’appareil (mobile, tablette, télévision, etc.).

### Règles spécifiques au contenu

Appliquez des limites différentes pour le contenu en direct et pour le contenu VOD.

### Stratégies Basées Sur L’Emplacement

Limitez le streaming en fonction de l’emplacement géographique ou du type de réseau.
