...
* [Attributs de métadonnées standard de surveillance de simultanéité](/help/concurrency-monitoring/technical/standard-metadata-attributes.md)
* [Présentation de l’API de surveillance de simultanéité](/help/concurrency-monitoring/api/cm-api-overview.md)
