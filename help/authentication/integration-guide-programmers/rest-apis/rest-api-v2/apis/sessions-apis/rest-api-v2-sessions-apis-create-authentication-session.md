...
### 3. Créer une session d&#39;authentification alors qu&#39;un profil valide existe déjà
...
### 4. Créez une session d’authentification à l’aide de TempPass de base ou promotionnel (non requis).
