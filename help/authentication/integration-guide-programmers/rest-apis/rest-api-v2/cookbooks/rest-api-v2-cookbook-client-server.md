...
* **Scénario 3 :** il n’existe aucun profil, l’application de diffusion en continu peut procéder à la fourniture d’un accès temporaire à l’utilisateur par le biais de la fonctionnalité [TempPass](/help/premium-workflow/temporary-access/temp-pass-feature.md).
