...
![Lancer une déconnexion unique pour un fichier mvpd spécifique](/help/authentication/assets/rest-api-v2/flows/single-sign-on-access-flows/rest-api-v2-initiate-single-logout-for-specific-mvpd-flow.png)
