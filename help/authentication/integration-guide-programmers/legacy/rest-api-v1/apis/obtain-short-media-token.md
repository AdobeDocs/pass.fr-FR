...
Le champ `serializedToken` de l’appel « Obtenir un jeton de média court » est un jeton codé en Base64 qui peut être vérifié par rapport à la bibliothèque de vérification des médias Adobe.
