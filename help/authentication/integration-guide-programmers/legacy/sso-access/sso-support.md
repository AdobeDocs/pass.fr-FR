...
* **Xbox One**- Un jeton Web JSON est émis, chiffré avec le certificat/la clé de l’éditeur et signé par Microsoft. Adobe extrait deviceID à partir d&#39;un paramètre appelé DPI (Device Pairwise ID), différent du paramètre Xbox 360 PDID (Partner Device ID). Le PDID existe également dans Xbox One, mais il est censé être remplacé par ce nouveau paramètre « Identifiant par paires d&#39;appareils » (DPI).
