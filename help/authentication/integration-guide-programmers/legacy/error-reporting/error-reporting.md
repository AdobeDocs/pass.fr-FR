...
| VSA203 | Infos | L’utilisateur a décidé de se déconnecter de l’application pendant l’authentification suite à une connexion via le SSO de la plateforme. | Demandez/demandez à l’utilisateur de se déconnecter explicitement de Paramètres -> Comptes -> Fournisseur de télévision sur tvOS. <br><br> Demandez/demandez à l’utilisateur de se déconnecter explicitement de Paramètres -> Fournisseur de télévision sur iOS/iPadOS. | Déconnectez-vous explicitement de Paramètres -> Comptes -> Fournisseur TV sur tvOS. <br> <br> Se déconnecter explicitement de Paramètres -> Fournisseur TV sur iOS/iPadOS | s.o. | Oui | s.o. |
