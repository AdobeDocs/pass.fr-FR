...
* API de préautorisation des SDK d’authentification Adobe Pass :
   * [SDK JavaScript (API de préautorisation)](../../legacy/sdks/javascript-sdk/preauthorize-api-javascript-sdk.md)
   * [SDK iOS/tvOS (API de préautorisation)](../../legacy/sdks/ios-tvos-sdk/preauthorize-api-ios-tvos-sdk.md)
   * [SDK Android (API de préautorisation)](../../legacy/sdks/android-sdk/preauthorize-api-android-sdk.md)
