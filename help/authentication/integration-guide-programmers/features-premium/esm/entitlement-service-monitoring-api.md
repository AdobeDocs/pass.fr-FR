...
| 405 | Méthode Non Autorisée | Indique qu’une méthode non prise en charge a été utilisée dans la requête. Bien que seule la méthode GET soit actuellement prise en charge, les versions ultérieures peuvent autoriser des OPTIONS ou HEAD |
