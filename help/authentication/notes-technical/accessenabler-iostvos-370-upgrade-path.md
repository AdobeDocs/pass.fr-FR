...
Les modifications apportées au stockage des chaînes de clés par la [nouvelle version d’AccessEnabler 3.7.0](/help/authentication/notes-releases/authn-rn-ios-tvos-370.md) sont incompatibles avec l’implémentation du stockage des chaînes de clés par la version inférieure à 3.7.0 d’AccessEnabler.
