...
+ Guide D’Intégration Pour Les Programmeurs {#integration-guide-programmers}
   ...
   + Fonctionnalités Premium {#features-premium}
      + {#temporary-access} d’accès temporaire
         + [Passage temp](integration-guide-programmers/features-premium/temporary-access/temp-pass.md)
         + [Succès temporaire promotionnel](integration-guide-programmers/features-premium/temporary-access/promotional-temp-pass.md)
         + [Réinitialiser la passe temporaire](integration-guide-programmers/features-premium/temporary-access/reset-temp-pass.md)
...
+ Notes de mise à jour {#release-notes}
   + {#release-notes-2024} 2024
      ...
      + [Notes De Mise À Jour De JavaScript 4.7.0 D’Authentification Adobe Pass](notes-releases/authn-rn-javascript-470.md)
   ...
   + {#release-notes-2022} 2022
      ...
      + [Notes De Mise À Jour De JavaScript 4.6.0 D’Authentification Adobe Pass](notes-releases/authn-rn-javascript-460.md)
   + {#release-notes-2021} 2021
      + [Notes De Mise À Jour De JavaScript 4.4.0 D’Authentification Adobe Pass](notes-releases/authn-rn-javascript-440.md)
