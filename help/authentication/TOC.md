...
- Versions du produit {#product-releases}
  - 2026 {#2026}
    - {hide-from-toc}[Notes de mise à jour de l’authentification Adobe Pass 3.9.0](notes-releases/auth-rn-390.md)
    - [Notes de mise à jour de l’authentification Adobe Pass version 3.8.0](notes-releases/auth-rn-380.md)
    - [Notes de mise à jour de l’authentification Adobe Pass version 3.7.0](notes-releases/auth-rn-370.md)
    - [Notes de mise à jour de l’authentification Adobe Pass version 3.6.0](notes-releases/auth-rn-360.md)
  - 2025 {#2025}
    - [Notes de mise à jour de l’authentification Adobe Pass Android 3.8.0](notes-releases/authn-rn-android-380.md)
    - [Notes de mise à jour de l’authentification Adobe Pass version 3.5.0](notes-releases/auth-rn-350.md)
...
- Guide D’Intégration Pour Les Programmeurs {#integration-guide-programmers}
  ...
  - Fonctionnalités Premium {#features-premium}
    ...
    - Service SSO {#sso-service}
      - [Service d’authentification unique d’Adobe](integration-guide-programmers/features-premium/sso-service/sso-service.md)
    - Analyses {#analytics}
...
- Guide de l’utilisateur pour le tableau de bord TVE {#user-guide-tve-dashboard}
  ...
  - [Tableau de bord ESM](/help/authentication/user-guide-tve-dashboard/tve-dashboard-esm.md)
