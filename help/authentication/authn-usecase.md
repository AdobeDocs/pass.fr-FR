...
| ID | Identifiant de la requête. Voir [SAML core 2.0-os](http://docs.oasis-open.org/security/saml/v2.0/saml-core-2.0-os.pdf){target=_blank} pour plus d’informations. |
...
| Format | Spécifie la référence URI correspondant à un format d’identifiant de nom Par défaut : urn:oasis:names:tc:SAML:2.0:nameid-format:l’Adobe transitoire recommande : urn:oasis:names:tc:SAML:2.0:nameid-format:persistant |
