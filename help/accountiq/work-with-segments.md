...
![Sélectionner Créer un segment](assets/d2c-create-new-segment.png)
...
**A.** [Catégories de vidéos](product-concepts.md#video-category-def) **B.** [Segment par défaut](#work-with-segments)
